...
public class GgoodsActivity extends Activity implements OnClickListener {
	private Context mContext; // 文件内容;
	private Button	  btnCode, // 扫码按钮;
			btnSearch, // 搜索按钮;
			//
			btnPhoto, // 拍照按钮;
			btnOid, // 运单扫码;
	...
	private void initView() {
		...
		btnOid = (Button) findViewById(R.id.btnOid);
	...
	private void initEvent() {
		...
		btnOid.setOnClickListener(this);
...
//				state1.setBackgroundColor(Color.GREEN);
	...
	public void onClick(View view) {
		...
		case R.id.btnFunction:
			mIntent = new Intent(mContext, GgHistoryActivity.class);
		...
		case R.id.btnOid:
			...
			mIntent = new Intent(mContext, FlushActivity.class);
			// 有返回值的跳转;
			startActivityForResult(mIntent, ConfigHelper.NTRACK_GGOODS_OID_TO);
			break;
		// 设置时间;
...
//				"wid="+ wid;
	...
	public void onActivityResult(int requestCode, int resultCode, Intent intent) {
		...
		} else if (requestCode == ConfigHelper.NTRACK_GGOODS_PHOTO_TO
				&& resultCode == -1) {
		...
		} else if (requestCode == ConfigHelper.NTRACK_GGOODS_OID_TO
				&& resultCode == ConfigHelper.NTRACK_FLUSH_TO_MENU) {
	...
	private void doResetParam2() {
		...
		// 拖车号;
		ettid.setText(ConfigHelper.SPACE);
		// 车型
		ettkind.setText(ConfigHelper.SPACE);
		// 铅封号;
		etoid.setText(ConfigHelper.SPACE);
		// 件数;
		etPercount.setText(ConfigHelper.SPACE);
		// 吨数;
		etPerweight.setText(ConfigHelper.SPACE);
		// 车数;
		etTcount.setText(ConfigHelper.SPACE);
		// 发车时间;
		stime = null;
		// bid置空&gid置空;
		bid = null;
