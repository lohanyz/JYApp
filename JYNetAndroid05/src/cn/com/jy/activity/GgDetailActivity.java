...
public class GgDetailActivity extends Activity implements OnClickListener{
	//	全程序内容;
	...
	private void initEvent(){
		mContext		=	GgDetailActivity.this;
