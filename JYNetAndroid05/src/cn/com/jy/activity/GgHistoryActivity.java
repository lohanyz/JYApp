...
public class GgHistoryActivity extends Activity implements OnClickListener{
	//	信息内容的全局变量;
	...
	private ConfigHelper	  mConfigHelper;//05.参数处理帮助类;
	
	private List<Map<String, String>> mList;//数据信息的加载;
	private Set<String>       mSetTmp;
	...
	private void initEvent(){
		mContext=GgHistoryActivity.this;
		//	数据库信息的加载;
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapter, View view, int position,
					long id) {
				Intent  intent	=new Intent(GgHistoryActivity.this, GgDetailActivity.class);
	...
	private List<Map<String, String>> loadData(){
		...
		sql		=	"select * from getgoodsinfo group by bid,gid ";
