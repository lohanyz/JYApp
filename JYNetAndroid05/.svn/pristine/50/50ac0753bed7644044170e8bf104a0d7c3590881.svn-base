...
import com.jy.camera.CameraManager;
import com.jy.decoding.CaptureActivityHandler;
import com.jy.decoding.InactivityTimer;
import com.jy.decoding.RGBLuminanceSource;

import com.jy.view.ViewfinderView;
public class FlushActivity extends Activity implements Callback {
	...
	private void onResultHandler(String resultString, Bitmap bitmap){
		...
		FlushActivity.this.setResult(ConfigHelper.NTRACK_FLUSH_TO_MENU,myIntent);
		FlushActivity.this.finish();
	}
